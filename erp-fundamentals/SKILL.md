...
**"SCM" (Supply Chain Management)** spans more than procurement, inventory, and orders: planning, manufacturing, logistics, and product lifecycle may also be in scope. Treat the list above as a starting checklist and confirm boundaries for the selected platform and industry before writing acceptance criteria. See [Oracle's SCM overview](https://www.oracle.com/scm/what-is-supply-chain-management/) (checked 2026-09-06).
