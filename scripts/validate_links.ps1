...
Get-ScopedFiles -Root $root -IgnoredTopLevelDirs $ignoredTopLevelDirs -Filter '*.md' | ForEach-Object {
    ...
    # Strip fenced code blocks; skip inline code while matching complete links.
    ...
    # Match a whole link before skipping inline code, preserving code-formatted labels.
