...
GitHub의 공개 스킬과 자료를 선별해 그대로 사용하거나 개선·보완하는 개인 저장소입니다. Claude Code/Cowork용 전문 스킬 29개와 라우터 `genie`, 총 30개를 관리합니다.
...
| 글·문서·도식 | `writing`, `curator`, `social-carousel`, `design-report`, `book-distiller`, `diagram-forge`, `explain-for-audience` |
