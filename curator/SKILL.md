...
- **epoko77-ai/im-not-ai** — [github.com/epoko77-ai/im-not-ai](https://github.com/epoko77-ai/im-not-ai), 3,825★ (checked 2026-07-18 via GitHub API), MIT license. Korean-language-specific stop-slop equivalent ("Humanize KR") — 10 categories/70 sub-patterns of Korean AI tells (translation-style phrasing, mechanical enumeration, clichés, passive-voice overuse) that hardikpandya/stop-slop's English-focused catalog doesn't cover. Run for Korean-language output specifically.
